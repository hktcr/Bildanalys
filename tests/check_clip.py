...
check('Bakgrund kan visas normalt',"value=\"image\"" in js and 'clipBg-image' in css)
check('Bakgrund kan dämpas',"value=\"dim\"" in js and 'clipBg-dim' in css and 'opacity:.16' in css)
check('Bakgrund kan döljas helt',"value=\"hidden\"" in js and 'clipBg-hidden' in css and 'opacity:0' in css)
check('Dold bakgrund är neutralgrå','background:#777' in css and 'neutralgrå' in js)
check('Bakgrund återställs när clipping lämnas',"classList.remove('clipBg-image','clipBg-dim','clipBg-hidden')" in js)
